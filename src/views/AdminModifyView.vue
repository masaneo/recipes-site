...
export default {
  ...
  async mounted() {
    ...
    // get recipe data
    await axios
      .get(process.env.VUE_APP_API_BASEURL + "recipes/admin/getRecipeData", {
        params: {
  ...
  methods: {
        ...
        axios
          .delete(
            process.env.VUE_APP_API_BASEURL +
              "recipes/admin/editRecipe/deleteIngredient",
            {
              data: {
                token: this.$store.state.token,
    ...
    deleteStepRow(id) {
      if (confirm("Na pewno chcesz usunąć ten krok z przepisu?")) {
        ...
        axios
          .delete(
            process.env.VUE_APP_API_BASEURL +
              "recipes/admin/editRecipe/deleteStep",
            {
              data: {
                token: this.$store.state.token,
                recipeId: this.recipe.recipe.recipeId,
    ...
    saveRecipe() {
      axios
        .put(process.env.VUE_APP_API_BASEURL + "recipes/admin/modifyRecipe", {
          token: this.$store.state.token,
